package com.everacosta.talleres.alarma.util;
...
import com.everacosta.talleres.alarma.data.DatabaseHelper;
import com.everacosta.talleres.alarma.model.Alarm;

import java.text.SimpleDateFormat;
import java.util.ArrayList;
import java.util.Locale;

import static com.everacosta.talleres.alarma.data.DatabaseHelper.COL_FRI;
import static com.everacosta.talleres.alarma.data.DatabaseHelper.COL_IS_ENABLED;
import static com.everacosta.talleres.alarma.data.DatabaseHelper.COL_LABEL;
import static com.everacosta.talleres.alarma.data.DatabaseHelper.COL_MON;
import static com.everacosta.talleres.alarma.data.DatabaseHelper.COL_SAT;
import static com.everacosta.talleres.alarma.data.DatabaseHelper.COL_SUN;
import static com.everacosta.talleres.alarma.data.DatabaseHelper.COL_THURS;
import static com.everacosta.talleres.alarma.data.DatabaseHelper.COL_TIME;
import static com.everacosta.talleres.alarma.data.DatabaseHelper.COL_TUES;
import static com.everacosta.talleres.alarma.data.DatabaseHelper.COL_WED;
import static com.everacosta.talleres.alarma.data.DatabaseHelper._ID;
